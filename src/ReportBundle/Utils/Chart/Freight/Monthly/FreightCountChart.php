...
/**
 * Klasa reprezentuje wykres z ilością wykonanych zleceń na dany miesiąc w roku
 *
 * @package ReportBundle\Utils\Chart\Freight\Monthly
 *
 * @author Bartłomiej Chojnowski <bachojnowski@gmail.com>
 */
class FreightCountChart extends MonthlyChart
{
    ...
    private function dataTable(Report $report)
    {
        ...
        foreach ($report->getResults()[$this->getYear()] as $result) {
            $table->addRow(array($result['month'], $result['freightCount']));
        }
