...
use AddressBundle\Form\AddressType;
...
class AddressController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AddressBundle:Address')->findAll();
     ...
     * @Method("POST")
     * @Template("AddressBundle:Address:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AddressBundle:Address')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AddressBundle:Address:edit.html.twig")
     */
